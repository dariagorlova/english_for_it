...
import '../core/model/phrase.dart' as _i13;
...
import '../features/words/testing_screen.dart/cubit/testing_cubit.dart' as _i14;
import 'seed_module.dart' as _i15;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factoryParam<_i12.PhrasesTestingCubit, List<_i13.Phrase>, dynamic>(
      (phrases, _) => _i12.PhrasesTestingCubit(
          get<int>(instanceName: 'translates_seed'), phrases));
  gh.factoryParam<_i14.TestingCubit, List<_i9.OneWord>, int>(
      (words, variantENtoUA) => _i14.TestingCubit(
          get<int>(instanceName: 'translates_seed'), words, variantENtoUA));
  return get;
}

class _$SeedModule extends _i15.SeedModule {}
