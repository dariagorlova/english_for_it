...
import '../features/phrases_screen/cubit/phrases_cubit.dart' as _i9;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i6.LearningCubit>(
      () => _i6.LearningCubit(get<_i3.DailyRepository>()));
  gh.factoryParam<_i7.PairsCubit, List<_i8.OneWord>, dynamic>(
      (words, _) => _i7.PairsCubit(words));
  gh.factory<_i9.PhrasesCubit>(
      () => _i9.PhrasesCubit(get<_i3.DailyRepository>()));
  ...
  gh.factoryParam<_i11.TestingCubit, List<_i8.OneWord>, int>(
